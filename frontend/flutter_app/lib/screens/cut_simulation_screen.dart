...
class CutSimulationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Cut Simulation')),
      body: prov.isLoading
          ? _CutLoadingBody(sequence: seq.sequence)
                ...
                children: [
                  ...
                  if (prov.cutResult != null)
                    AnimatedSwitcher(
                      ...
                      child: _CutResultCard(
                        key: ValueKey(prov.cutResult!.cutPosition),
                        prov: prov,
                      ),
                    ),
                  if (prov.cutResult != null) const SizedBox(height: kPadMd),
...
class _CutLoadingBody extends StatelessWidget {
  final String sequence;
  const _CutLoadingBody({required this.sequence});
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          Text(
            'Simulating cut at target locus',
...
class _CutResultCard extends StatelessWidget {
  ...
  const _CutResultCard({super.key, required this.prov});
